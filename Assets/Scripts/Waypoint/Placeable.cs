...
public class Placeable : MonoBehaviour, IInputClickHandler
{
    ...
    // The standard offset to elevate off the floor.
    private float floorOffset = 1f;
    ...
    private void Awake()
    {
        //floorOffset = FindObjectOfType<SurfacePlane>().PlaneThickness * 15;
    ...
    public void OnPlacementStop()
    {
        ...
        targetPosition += 0.01f * surfaceNormal;
