...
/// <summary>
/// Reports spatial understanding data to the user while they are 
/// scanning their space.
/// </summary>
public class SpatialUnderstandingState : Singleton<SpatialUnderstandingState>, IInputClickHandler, ISourceStateHandler
{
            ...
            if (SpatialUnderstanding.Instance.AllowSpatialUnderstanding)
            {
                switch (SpatialUnderstanding.Instance.ScanState)
                {
                    ...
                    case SpatialUnderstanding.ScanStates.Done:
                        return "Air tap when the scanned space is computed";
                    default:
    ...
    void IInputClickHandler.OnInputClicked(InputClickedEventData eventData)
    {
            ...
            !SpatialUnderstanding.Instance.ScanStatsReportStillWorking)
        {
            ...
            //SpatialUnderstandingCustomMesh.Instance.DrawProcessedMesh = false;
        }
        else if (gameObject.activeSelf && SpatialUnderstanding.Instance.ScanState == SpatialUnderstanding.ScanStates.Done)
        {
